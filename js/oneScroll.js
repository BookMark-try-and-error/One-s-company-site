$(function(){
	...
	if(downBtn == 'show'){
		setWrap.append('<div id="pageDown"><a href="javascript:void(0);"><span></span>scroll</a></div>');
	}
	...
	$(window).load(function(){
		...
		stageSlide.each(function(){
			...
			thisSlide.append('<a href="javascript:void(0);" class="sdPrev"><span class="back text">Back</span></a><a href="javascript:void(0);" class="sdNext"><span class="next text">Next</span></a><div class="slideNav"></div>');

			$('.sdPrev').mouseover(function() {
				$('.back').addClass('appear');
			});
			$('.sdPrev').mouseout(function() {
				$('.back').removeClass('appear');
			});
			$('.sdNext').mouseover(function() {
				$('.next').addClass('appear');
			});
			$('.sdNext').mouseout(function() {
		...
		function motionUp(){
			...
			if(!(contTopUp === 0)){
				...
				if (setPrev > 1) {
					$('.bar, .menu_trigger').addClass('extension');
				}else {
					$('.bar, .menu_trigger').removeClass('extension');
				}
